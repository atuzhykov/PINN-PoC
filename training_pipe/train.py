...
def train():
    ...
    model_names = ["LSTM_with_Attention"]
    ...
    df, features = data_processor.all_index_data_preparator(df, include_derived_features=True) if use_all_data else data_processor.one_index_data_preparator(
